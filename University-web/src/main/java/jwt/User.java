...
public class User {
    ...
    public static final String FIND_ALL = "jwt.User.findAll";
    public static final String COUNT_ALL = "jwt.User.countAll";
    public static final String FIND_BY_LOGIN_PASSWORD = "jwt.User.findByLoginAndPassword";
    ...
    private void setUUID() {
        ...
        password = Password.digestPassword(password);
    }
